      ...
      <div style={{ maxWidth: 1150, margin: "0 auto", padding: "18px 20px 48px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 14 }}>
          ...
          <div style={{ background: `linear-gradient(180deg, ${BGS.A}0.04) 0%, ${BGS.A}0.01) 100%)`,
            ...
            <Slider label="Tax Benefit (Depreciation)" value={taxBenefitPctA} onChange={setTaxBenefitPctA} min={0} max={5} step={0.1} prefix="" suffix="% of property value per year (tax savings)" color={COLORS.A} tooltip="Rental properties can deduct annual depreciation (~1/27.5 of the building value, based on original purchase price, not current value) from taxable income, sheltering rental income from taxes. This slider adds the equivalent annual savings to Option A's cash flow. 0% = no tax effect (default). 0.5% ≈ typical landlord in the 22–24% tax bracket. 1.0% ≈ higher bracket or high building-value ratio. Values above that are aggressive custom assumptions. Applied to all years as a simplification (no proration for the house-hack phase). Does NOT model: mortgage interest deduction, passive loss rules, depreciation recapture on sale, or state taxes." />
          </div>
          {/* B */}
